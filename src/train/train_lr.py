...
def train_logistic_regression(data_path: str, model_save_path: str, scaler_save_path: str):
    ...
    print("[-] Logistic Regression modeli eğitiliyor... Lütfen bekleyin.")
    ...
    print("\n" + "="*50)
    print(f"[+] Lojistik Regresyon (Logistic Regression) Eğitimi Tamamlandı!")
...
if __name__ == "__main__":
    ...
    scaler_file = os.path.join(model_dir, 'lr_scaler.pkl')
    train_logistic_regression(data_file, model_file, scaler_file)
